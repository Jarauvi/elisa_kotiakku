    ...
    payload = [
        {
            ...
            "solar_power_kw": 2.5,
            "solar_array_1_power_kw": 0.5,
            "solar_array_2_power_kw": 1.0,
            "solar_array_3_power_kw": 0.5,
            "solar_array_4_power_kw": 0.5,
            "grid_power_kw": -1.0,
            "house_power_kw": 0.3,
...
async def test_coordinator_handles_null_values(hass, mock_config_entry):
    ...
    payload = [{
        ...
        "solar_power_kw": None,
        "solar_array_1_power_kw": None,
        "solar_array_2_power_kw": None,
        "solar_array_3_power_kw": None,
        "solar_array_4_power_kw": None,
