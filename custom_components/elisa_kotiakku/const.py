...
CONF_ADD_SPOT_PRICE_MARGIN = "add_spot_price_margin"
DEFAULT_ADD_SPOT_PRICE_MARGIN = False
CONF_SPOT_PRICE_MARGIN = "spot_price_margin"
DEFAULT_SPOT_PRICE_MARGIN = 0.0
