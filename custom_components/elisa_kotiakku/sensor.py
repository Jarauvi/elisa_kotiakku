...
ICON_MAP = {
    ...
    "solar_array_1_power_kw": "mdi:solar-panel-large",
    "solar_array_2_power_kw": "mdi:solar-panel-large",
    "solar_array_3_power_kw": "mdi:solar-panel-large",
    "solar_array_4_power_kw": "mdi:solar-panel-large",
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    sensors = [
        ...
        KotiakkuPowerSensor(coordinator, "solar_array_1_power_kw", device_id, device_slug, entry),
        KotiakkuPowerSensor(coordinator, "solar_array_2_power_kw", device_id, device_slug, entry),
        KotiakkuPowerSensor(coordinator, "solar_array_3_power_kw", device_id, device_slug, entry),
        KotiakkuPowerSensor(coordinator, "solar_array_4_power_kw", device_id, device_slug, entry),
