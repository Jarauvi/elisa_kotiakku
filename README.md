...
> [!IMPORTANT]
> **Note:** This is a **work-in-progress** integration without a functional official API. For testing purposes, a **fastapi server** can be found in this repo: https://github.com/Jarauvi/kotiakku_test_server 🧪
